...
2) Run hello.py
--------------------------------------------------------------------------------------------------
3) Data from txt file is already been loaded into postgres DB. (You can find it on Postgres script).
4) Total no. of files being used: 4. (i.e., hello.py, data.csv,Assignment.html,postgres DB).
--------------------------------------------------------------------------------------------------
